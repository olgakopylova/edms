<div class="row">
    ...
    <div class="col-md-10"><p class="h5">Поручения</p></div>
</div>
<div class="row">
    <a class="btn btn-sm btn-outline-success float-right btn-top" href="/edms/{#user}/create/errand" target="_blank" role="button"> Создать поручение </a>
