...
<div class="row">
    <a class="btn btn-sm btn-outline-success float-right btn-top" href="/edms/{#user}/create/assignment" target="_blank" role="button"> Создать замещение </a>
